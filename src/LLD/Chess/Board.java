...
public class Board {
    ...
    private void initializeBoard(){
       ...
       blocks[0][1] = new Block(0,1,new Bishop(true));
       blocks[0][2] = new Block(0,2,new Knight(true));
       blocks[0][3] = new Block(0,3,new Queen(true));
       blocks[0][4] = new Block(0,4,new King(true));
       blocks[0][5] = new Block(0,5,new Knight(true));
       blocks[0][6] = new Block(0,6,new Bishop(true));
       ...
       for(int j=0;j<8;j++){
        ...
        blocks[7][1] = new Block(7,1,new Bishop(false));
        blocks[7][2] = new Block(7,2,new Knight(false));
        blocks[7][3] = new Block(7,3,new Queen(false));
        blocks[7][4] = new Block(7,4,new King(false));
        blocks[7][5] = new Block(7,5,new Knight(false));
        blocks[7][6] = new Block(7,6,new Bishop(false));
